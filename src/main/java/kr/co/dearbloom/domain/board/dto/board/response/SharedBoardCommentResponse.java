...
public record SharedBoardCommentResponse(
        @Schema(description = "공동보드 댓글 ID", example = "7")
        Long sharedBoardCommentId,
    ...
    public static SharedBoardCommentResponse from(SharedBoardComment sharedBoardComment) {
        return new SharedBoardCommentResponse(
                sharedBoardComment.getSharedBoardCommentId(),
                sharedBoardComment.getCustomer().getName(),
                sharedBoardComment.getContent(),
                sharedBoardComment.getCreatedAt());
    }
}
