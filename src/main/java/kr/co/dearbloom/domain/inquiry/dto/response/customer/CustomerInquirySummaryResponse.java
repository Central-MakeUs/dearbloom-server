...
/** 고객 문의 리스트 항목. 신청 최근순으로 반환된다. */
@Schema(description = "고객 문의 리스트 항목")
public record CustomerInquirySummaryResponse(
    ...
    public static CustomerInquirySummaryResponse of(Inquiry inquiry, String artworkImageUrl) {
        return new CustomerInquirySummaryResponse(
